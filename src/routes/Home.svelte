<script>
    ...
    function get_teacher_student_classrooms() {
        fastapi(
            "get",
            `/edu/evaluate/my-classroom/list`,
            {},
            (json) => {
                teacher_my_classroom_list = json.my_classroom_list;
                    ...
                    fastapi(
                        ...
                        (json1) => {
                            if (current_classroom == 0) {
                                ...
                                for (
                                    let i = 0;
                                    i < student_classroom_list.length;
                                    i++
                                ) {
                            ...
                            fastapi(
                                ...
                                {},
                                (json2) => {
                                    student_my_classroom_list =
                                        json2.my_classroom_list;
                                    // console.log( `my_classroom_list=\n${JSON.stringify(my_classroom_list)}`,);
                                    for (
                                        let i = 0;
                                        i < student_my_classroom_list.length;
                                        i++
                                    ) {
                                        let obj = student_my_classroom_list[i];
                                        student_my_classroom_dict[
                                            obj["classroom_idx"]
                                        ] = obj;
                                    }
                                    ...
                                    for (
                                        ...
                                        let obj = student_classroom_list[i];
                                        student_classroom_dict[obj["idx"]] =
                                            obj;
                                    }
                                    student_classroom_title =
                                        student_classroom_dict[
                                            current_classroom
                                        ].title;
...
{#if $is_student == true}
    ...
    {:else}
        ...
        {:then}
            ...
            <span class="ms-5 me-5 mt-1 ps-3 fw-bold"
                >{student_classroom_title}</span
            >
            <h5 class="ms-5 me-5 mt-3 mb-2 border-bottom">디지털 교과서</h5>
            <div class="alert alert-info ms-5 me-5" role="alert">
                본 교육 플랫폼은 <span style="color:blue; font-weight:bold;">수업 후 진행되는 평가 도구</span>입니다.<br />
                <br />
                학생은 교사의 수업을 들은 후,<br />
            ...
            <div
                id="carouselExample"
                class="carousel carousel-dark slide ms-5 me-5"
            >
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{carousel_img_list[carousel_img_idx]}" class="d-block w-100" alt="" />
                    </div>
                </div>
                <button
...
{:else if $is_teacher == true}
    {#await get_teacher_student_classrooms()}
        <div
            class="d-flex justify-content-center"
            style="height:300px; padding-top: 150px;"
        >
                ...
                <tbody>
                    {#each teacher_my_classroom_list as classroom, idx}
                        <tr class="text-center">
                            ...
                            <td
                                >{teacher_student_dict[classroom.userid]
                                    .username}</td
                            >
                            <td
        ...
        <form method="post">
            ...
            <div class="d-flex justify-content-between">
                <button
                    ...
                    type="submit"
                    on:click={login_user}>로그인</button
                >
